...
class _FoodCheck02State extends State<FoodCheck02> {
  ...
  List<String> lunchItems = ["Posho", "beans", "Peas", "Chicken"];
  String selectedItem03 = "Meat";
  List<String> supperItems = ["Meat", "Matooke", "Maize", "Rice"];
  ...
  calcLunch() {
    ...
    } else if (selectedItem02 == "Chicken") {
      return Text(
        "You have chosen ${selectedItem02} :" + "\n" + "3g of protein",
        style: const TextStyle(
          color: Colors.black,
